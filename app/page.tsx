...
import { Phone, Mail, MapPin, Star, Shield, Clock, Award, CheckCircle, Menu, X } from "lucide-react"
  ...
  <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 flex flex-col items-center text-center">
    ...
    >
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-b from-gray-800 to-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">See The Transformation</h2>
          ...
          <div className="text-center">
            {/* Updated button to use silver gradient */}
            <Button className="bg-gradient-to-r from-gray-600 to-gray-500 hover:from-gray-500 hover:to-gray-400 text-white border border-gray-400">
